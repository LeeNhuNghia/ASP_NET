<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calendard.aspx.cs" Inherits="Lad01.Calendard" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="lbToday" runat="server" ForeColor="Red"></asp:Label>
        </div>
        <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text="Chọn ngày sinh nhật của bạn:"></asp:Label>
